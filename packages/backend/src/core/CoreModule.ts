...
import { CheckinableEntityService } from './entities/CheckinableEntityService.js';
...
const $CheckinableEntityService: Provider = { provide: 'CheckinableEntityService', useExisting: CheckinableEntityService };
