...
const $checkinableRepository: Provider = {
	provide: DI.checkinableRepository,
	useFactory: (db: DataSource) => db.getRepository(Checkinable),
	inject: [DI.db],
};
