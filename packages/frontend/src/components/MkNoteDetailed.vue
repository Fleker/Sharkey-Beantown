		...
		<article :class="$style.note" @contextmenu.stop="onContextmenu">
			<header :class="$style.noteHeader">
				...
				<div :class="$style.noteHeaderBody">
					...
					<div v-if="appearNote.checkinLocation">
						at {{ appearNote.checkinLocation }}
					</div>
			...
			<div :class="$style.noteContent">
				...
				<div v-show="appearNote.cw == null || showContent">
					...
					<div v-if="appearNote.checkinLabel">
						<table>
							<tr>
								<td rowspan="3">
									<img :src="appearNote.checkinLogo" style="width:48px;height:48px;display:inline-block;vertical-align:sub;"/>
								</td>
								<td>
									<strong>
									{{ appearNote.checkinLabel }}
								</strong>
								</td>
							</tr>
							<tr><td>
								<small> {{ appearNote.checkinSource }}</small>
							</td></tr>
							<tr><td>
								<small> {{ appearNote.checkinClass }}</small>
							</td></tr>
						</table>
					</div>
					<Mfm
						...
						:isAnim="allowAnim"
					/>
					<div v-if="appearNote.checkinRating">
						<hr>
						<span style="padding-left:32px;">
							{{ appearNote.checkinRating }} / 5 Stars
						</span>
						<span style="float:right;padding-right:32px;">{{ appearNote.checkinServing }}</span>
					</div>
