...
<template>
	<div :class="$style.root">
		...
		<button v-if="!isDesktop && !isMobile" :class="$style.widgetButton" class="_button" @click="widgetsShowing = true" style="display:none"><i class="ph-squares-four ph-bold ph-lg"></i></button>
	
		<div v-if="isMobile" ref="navFooter" :class="$style.nav" style="display:none">
